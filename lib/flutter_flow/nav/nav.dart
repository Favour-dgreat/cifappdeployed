...
import 'package:Cefmorsi/pages/event_details/event_details_widget.dart';
...
import '/privacy/privacy_policy_widget.dart';
...
class AppStateNotifier extends ChangeNotifier {
  ...
  if (_redirectLocation == null) {
    throw StateError('Redirect location was requested but is null');
  }
  return _redirectLocation as String;
  }  
    ...
    FFRoute(
      ...
      routes: [
        ...
        FFRoute(
          name: 'BookDetails',
          path: 'bookDetails',
          builder: (context, params) => const BookDetailsWidget(title: '', author: '', imageUrl: '', summary: '', link: '',),
        ),
        FFRoute(
          name: 'Videos',
          path: 'videos',
        ...
        FFRoute(
          ...
          builder: (context, params) => const MagazinesDetailsWidget(title: '', author: '', imageUrl: '', summary: '', link: '', ),
        ),
        FFRoute(
          name: 'Events',
          path: 'events',
        ...
        FFRoute(
         ...
         FFRoute(
          name: 'eventsDetails',
          path: 'eventsDetails',
          builder: (context, params) => const EventDetailsWidget(imageUrl: '', title: '', frequency: '', summary: '', link: '',),
