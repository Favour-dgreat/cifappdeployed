...
import 'package:Cefmorsi/index.dart';
...
class MagazinesWidget extends StatefulWidget {
  static String routeName = 'Magazines';
  static String routePath = 'magazines';
...
class MagazinessModel extends FlutterFlowModel {
...
class _MagazinesWidgetState extends State<MagazinesWidget> {
  ...
  void initState() {
    ...
    futureData = fetchMagazinesData();
  }

  Future<List<dynamic>> fetchMagazinesData() async {
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
                      ...
                      child: FutureBuilder<List<dynamic>>(
                        ...
                        builder: (context, snapshot) {
                          return FFButtonWidget(
                            ...
                            text: 'Magazines (${snapshot.data?.length ?? 0})',
              ...
              Expanded(child: buildMagazinesLists(() => fetchMagazinesData())),
...
Widget buildMagazinesLists(
  Future<List<dynamic>> Function() fetchMagazinesData,
) {
  return FutureBuilder<List<dynamic>>(
    future: fetchMagazinesData(),
    builder: (context, snapshot) {
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return buildMagazineItems(context, magazine);
        },
      );
    },
  );
...
Widget buildMagazineItems(BuildContext context, dynamic magazine) {
  return Padding(
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      magazine['title'] != null && magazine['title'].length > 16
                          ? magazine['title'].substring(0, 18) + '...'
                          : magazine['title'] ?? '',
