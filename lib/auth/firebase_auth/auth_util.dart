...
Stream<dynamic>? _jwtTokenStream;
Stream<dynamic> get jwtTokenStream {
  _jwtTokenStream ??= FirebaseAuth.instance
      .idTokenChanges()
      .map((user) async => _currentJwtToken = await user?.getIdToken())
      .asBroadcastStream();
  return _jwtTokenStream!;
}
...
Stream<UsersRecord?>? _authenticatedUserStream;
Stream<UsersRecord?> get authenticatedUserStream {
  _authenticatedUserStream ??= FirebaseAuth.instance
      .authStateChanges()
  ...
  return _authenticatedUserStream!;
}
